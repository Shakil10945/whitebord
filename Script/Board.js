var canvas = document.querySelector("canvas");
        ...
        document.getElementById("2").addEventListener("click",function(){
            ColorVariable = "#cddcdd";
        });
        document.getElementById("3").addEventListener("click",function(){
            ColorVariable = "#F11111";
        });
        document.getElementById("4").addEventListener("click",function(){
            ColorVariable = "#000000";
        });
...
//         ColorVariable = "#85aaBB";
// });
// document.querySelector("#5").addEventListener("click",function(){
//     ColorVariable = "#faffaa";
// });
// document.querySelector("#6").addEventListener("click",function(){
//     ColorVariable = "#ffffff";
// });



        // document.querySelectorAll(".c").forEach(Col=>{
        //     Col.addEventListener('mousedown',function(){
        //         ColorVariable = this.getAttribute("data-color")
